    ...
    return Response(
        {
            ...
            "phrases": {
                ...
                "frequency": reverse("phrases-frequency", request=request, format=format),
                "wordlist": reverse("phrases-wordlist", request=request, format=format),
            ...
            "transcriptions": {
                ...
                "wordlist": reverse("transcriptions-wordlist", request=request, format=format),
